...
session_start();
			$roll=$_SESSION['roll'];
$query ="SELECT * FROM `studentinfo` WHERE `roll`='$roll' ";
...
<div class="heading"><img src="logo.jpg" alt="LOGO" width="150px;" height="150px;" ><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <div class="patti">
		...
		echo '<td>'.$query_execute['contact'].'</td>';
		echo '
		</tr>
		<tr>
		<td >';
		echo '<br><b>Email:<b>';
		echo '<td>'.$query_execute['email'].'</td><br>';
		echo '
		</tr>
		<tr>
		<td>';
		echo '<br><b>DOB:<b>';
		echo '<td>'.$query_execute['dob'].'<br></td>';
		'</tr>
		...
		echo '<div style="float:right;margin-right:10%;"><form action="mainslogin.php" method="post"><input type="submit" value="Back"></form></div>
