...
<body>
    <div class="heading"><img src="logo.jpg" alt="LOGO" width="150px;" height="150px;" ><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <form style="margin:20px;" action="for_pas_techmain.php" method="POST">
           ...
           <p style="margin:10px;">New User Create Password</p>
				...
				Enter Your Enrollment No : <br/><input type="text" name="fid" value="'.$fid.'" readonly>
				<br/>
                <br/>';
				$s_detail="SELECT `fques`,`fans` FROM `facultyinfo` WHERE fid=$fid";
				if($check=mysqli_query($con,$s_detail))
				{	$run=mysqli_fetch_assoc($check);
				echo 'Security Question : <br/> <p><h3>';  echo $run['fques'].'</h3></p>
				<br/>
                <br/>
				Enter Your Answer      : <br/>   <input type="text" name="fans" >
				<br/>
                <br/>
                Enter your NEW Password      : <br/>   <input type="password" name="fpassword" required>
                <br/>
                <br/>
