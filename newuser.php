...
<body>
    <div class="heading"><img src="logo.jpg" alt="LOGO" width="150px;" height="150px;" ><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <form style="margin:20px;" action="registration.php" method="POST">
           ...
           <p style="margin:10px;">New User Create Password</p>
				...
				ENTER YOUR ENROLLMENT NO : <br/><input type="text" name="roll" required>
				<br/>
                <br/>
				Security Question : <br/> <input type="text" name="ques" required>
				<br/>
                <br/>
				Enter Your Answer      : <br/>   <input type="text" name="ans" required>
				<br/>
                <br/>
				
                Enter your password      : <br/>   <input type="password" name="password" required>
                <br/>
                <br/>
