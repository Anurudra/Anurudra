...
<body>
    <div class="heading"><!--<img src="1.jpg" alt="LOGO" width="150px;" height="150px;" >--><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <div class="patti">
		...
		<p>
		&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;WELCOME: <?php require 'connect.php';
		
			session_start();
			echo '<strong style="color:crimson;">'.$_SESSION['aname'].'</strong>';
        ...
        <div>
             <img src="login.png" alt="image" style="opacity:0.5; margin-left:300px; width:300px;height:300px;">
        <ul>
            <li><a href="admindetails.php"> Admin Details</a></li>
        <br/>
            <li><a href="adminpasschange.php"> Change Password</a></li>
            <br/>
            <li><a href="registerteacher.php"> Register New Teacher </a></li>
            <br/>
        ...
        <a href="adminlogin.html" style="margin:90px;float:right;border:2px solid black; background-color:crimson; color:white; padding:3px">Logout</a>
        <pre>
