...
<body>
    <div class="heading"><img src="logo.jpg" alt="LOGO" width="150px;" height="150px;" ><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <form style="margin:20px;" action="fregistration.php" method="POST">
        
            <div>
           <p style="margin:10px;">New Teacher Create Password</p>
                <br/>
                <br/>
                <br/>
				
				
				Enter Your Faculty ID : <br/><input type="text" name="fid" required>
				<br/>
                <br/>
				Security Question : <br/> <input type="text" name="fques" required>
				<br/>
                <br/>
				Enter Your Answer      : <br/>   <input type="text" name="fans" required>
				<br/>
                <br/>
				
                Enter your password      : <br/>   <input type="password" name="fpassword" required>
                <br/>
                <br/>
