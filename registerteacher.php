...
<body>
    <div class="heading"><img src="logo.jpg" alt="LOGO" width="150px;" height="150px;" ><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <form style="margin:20px;" action="admintregister.php" method="POST">
        
            <div>
           <p style="margin:10px;">New Teacher Registration</p>
                <br/>
                <br/>
                <br/>
				
				
				ENTER Faculty ID : &emsp;&emsp;&emsp;&emsp;  <input type="text" name="fid" required>
				<br/>
                <br/>
				<br/>
                <br/>
				Enter Faculty Name : &emsp;&emsp; &emsp;<input type="text" name="fname" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Faculty Contact :   &emsp;&emsp; <input type="text" name="fcontact" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Faculty email : &emsp; &emsp;&emsp;  <input type="email" name="femail" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Faculty DOB : &emsp; &emsp;&emsp;  <input type="date" name="fdob" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Faculty Branch:&emsp;  &emsp; <input type="text" name="fbranch" required>
				<br/>
                <br/>
				<br/>
                <br/>
