...
$sql="SELECT * FROM `facultyinfo` WHERE fid='$fid'";
...
<body>
     <div class="heading"><img src="logo.jpg" alt="LOGO" width="150px;" height="150px;" ><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <form style="margin:20px;" action="admintupdatefinal.php" method="POST">
        
            <div>
           <p style="margin:10px;">Update Teacher Registration</p>
                <br/>
                <br/>
                <br/>
				
				
				ENTER ENROLLMENT NO :   <input type="text" name="fid" value="'.$list['fid'].'"  required diasbled>
				...
				<br/>
                <br/>
				Enter Faculty Name : &emsp;&emsp; &emsp;<input type="text" name="fname" value="'.$list['fname'].'" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Faculty Contact :   &emsp;&emsp; <input type="text" name="fcontact" value="'.$list['fcontact'].'" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Faculty email : &emsp; &emsp;&emsp;  <input type="email" name="femail" value="'.$list['femail'].'" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Faculty DOB : &emsp; &emsp;&emsp;  <input type="date" name="fdob" value="'.$list['fdob'].'" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Faculty Branch:&emsp;  &emsp; <input type="radio" name="fbranch" value="cs" >Computer Science  &emsp;
				<input type="radio" name="fbranch" value="it"> Information Technology &emsp;
				<br/>
                <br/>
				<br/>
                <br/>
