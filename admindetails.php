...
session_start();
			$aid=$_SESSION['aid'];
$query ="SELECT * FROM `admininfo` WHERE `aid`='$aid' ";
...
<div class="heading"><img src="logo.jpg" alt="LOGO" width="150px;" height="150px;" ><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <div class="patti">
		...
		<td>';
			echo '<b>Name:<b></td>';
		echo '<td>'.$query_execute['aname'].'</td>';
		echo '
		</tr>
		<tr>
		<td >';
		echo '<br><b>Contact:<b></td>';
		echo '<td>'.$query_execute['acontact'].'</td>';
		echo '
		</tr>
		<tr>
		<td >';
		echo '<br><b>Email:<b>';
		echo '<td>'.$query_execute['aemail'].'</td><br>';
		echo '
		</tr>
		<tr>
		<td>';
		echo '<br><b>DOB:<b>';
		echo '<td>'.$query_execute['adob'].'<br></td>';
		'</tr>
		...
		echo '<div style="float:right;margin-right:10%;"><form action="adminmain.php" method="post"><input type="submit" value="Back"></form></div>
