...
<body>
    <div class="heading"><img src="logo.jpg" alt="LOGO" width="150px;" height="150px;" ><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <form style="margin:20px;" action="adminchangepass.php" method="POST">
           ...
           <p style="margin:10px;">Change Password</p>
				...
				Admin  ID : <br/><input type="text" name="roll" value="<?php require 'connect.php';  session_start(); echo $_SESSION['aid'];?>" disabled>
				<br/>
                <br/>
				
				
                Enter Your New Password      : <br/>   <input type="password" name="apassword" required autofocus>
                <br/>
                <br/>
                 <br/>
                <br/> <br/>
