...
<body>
    <div class="heading"><img src="logo.jpg" alt="LOGO" width="150px;" height="150px;" ><strong><h1 style="float:right;">RUSTAMJI INSTITUTE OF TECHNOLOGY</br>(An Institute Of Border Security Force)</h1</strong></div>
       ...
       <form style="margin:20px;" action="adminsregister.php" method="POST">
        
            <div>
           <p style="margin:10px;">New Student Registration</p>
                <br/>
                <br/>
                <br/>
				
				
				ENTER ENROLLMENT NO :   <input type="text" name="roll" required>
				<br/>
                <br/>
				<br/>
                <br/>
				Enter Student Name : &emsp;&emsp; &emsp;<input type="text" name="name" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Student Contact :   &emsp;&emsp; <input type="text" name="contact" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Student email : &emsp; &emsp;&emsp;  <input type="email" name="email" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Student DOB : &emsp; &emsp;&emsp;  <input type="date" name="dob" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Student Branch:&emsp;  &emsp; <input type="text" name="branch" required>
				<br/>
                <br/><br/>
                <br/>
				Enter Student Sem:&emsp;  &emsp; <input type="text" name="sem" required>
